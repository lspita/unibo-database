...
SELECT 
    ...
    s.Phone
FROM 
    Shippers AS s JOIN Orders AS o ON s.ShipperID = o.ShipVia
...
FROM 
    Orders AS o
    JOIN `Order Details` AS od ON o.OrderID = od.OrderID
WHERE od.ProductID IN (SELECT * FROM MostExpensiveProduct);
